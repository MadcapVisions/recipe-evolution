...
export const COOKING_SCOPE_MESSAGE =
  "I can help with cooking-focused requests only. Ask about dishes, ingredients, substitutions, technique, timing, meal planning, grocery planning, or how to improve this recipe.";
