...
exports.CHEF_CHAT_REGRESSION_EXAMPLES = [
    ...
    {
        role: "assistant",
        content: "Go in one of three directions: a salmon rice bowl with soy-lime dressing, a quick salmon fried rice with scallions, or a chilled sushi-inspired bowl with cucumbers and sesame. The fastest and cleanest option is the rice bowl because you can roast or pan-sear the salmon and build around it. Add something sharp like rice vinegar or lime so it doesn’t taste flat.",
    },
    {
        role: "user",
    ...
    {
        role: "assistant",
        content: "OPTION 1: Roasted tomato-chile salsa with garlic, lime, and cilantro for a bright classic dip. OPTION 2: Smoky black bean queso-style dip with cumin, jalapeno, and cheddar for something warmer and richer. OPTION 3: Avocado-lime crema with scallions and hot sauce for a cooler, sharper contrast. The strongest option is the roasted tomato-chile salsa because it stays bright, snackable, and easy to batch.",
    },
    {
        role: "user",
