...
type RecipeSidebarProps = RecipeNavigationSectionProps &
  VersionRailSectionProps & {
...
export function VersionRailSection({
  currentVersion,
  recipe,
  timelineVersions,
  timelineHasMore,
    ...
    <aside className="flex flex-col gap-4">
      <div ref={navigationRef}>
        <RecipeNavigationSection
          ...
          recipe={props.recipe}
          recipeSearch={props.recipeSearch}
          searchResults={props.searchResults}
          sidebarActionError={props.sidebarActionError}
          onRecipeSearchChange={props.onRecipeSearchChange}
          onRecipeNavigate={props.onRecipeNavigate}
          onOpenRecipeMenu={props.onOpenRecipeMenu}
        />
      </div>
      <div ref={historyRef}>
        <VersionRailSection
          ...
          recipe={props.recipe}
          timelineVersions={props.timelineVersions}
          timelineHasMore={props.timelineHasMore}
          timelineLoadingMore={props.timelineLoadingMore}
          onVersionNavigate={props.onVersionNavigate}
          onLoadMoreVersions={props.onLoadMoreVersions}
          onOpenVersionMenu={props.onOpenVersionMenu}
        />
      </div>
    </aside>
  );
